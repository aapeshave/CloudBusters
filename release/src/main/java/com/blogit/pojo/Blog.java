...
/*
 * This class is for Blog where it has all the information regarding each blog.
 */
public class Blog {
	...
	public Blog(String blogID, String blogName, String blogDescription, String userID) {
		this();
		this.blogID = blogID;
